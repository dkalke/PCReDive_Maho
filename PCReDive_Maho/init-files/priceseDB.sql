...
CREATE TABLE IF NOT EXISTS `month` (
  ...
  `boss1_4` int(11) DEFAULT NULL,
  `boss1_5` int(11) DEFAULT NULL,
  `boss2_1` int(11) DEFAULT NULL,
  `boss2_2` int(11) DEFAULT NULL,
  `boss2_3` int(11) DEFAULT NULL,
  `boss2_4` int(11) DEFAULT NULL,
  `boss2_5` int(11) DEFAULT NULL,
  `boss3_1` int(11) DEFAULT NULL,
  `boss3_2` int(11) DEFAULT NULL,
  `boss3_3` int(11) DEFAULT NULL,
  `boss3_4` int(11) DEFAULT NULL,
  `boss3_5` int(11) DEFAULT NULL,
  `boss4_1` int(11) DEFAULT NULL,
  `boss4_2` int(11) DEFAULT NULL,
  `boss4_3` int(11) DEFAULT NULL,
  `boss4_4` int(11) DEFAULT NULL,
  `boss4_5` int(11) DEFAULT NULL,
  `boss5_1` int(11) DEFAULT NULL,
  `boss5_2` int(11) DEFAULT NULL,
  `boss5_3` int(11) DEFAULT NULL,
  `boss5_4` int(11) DEFAULT NULL,
  `boss5_5` int(11) DEFAULT NULL
