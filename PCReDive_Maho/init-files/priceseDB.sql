...
DROP DATABASE IF EXISTS `princess_connect`;
...
CREATE TABLE IF NOT EXISTS `group` (
  ...
  `policy` tinyint(1) unsigned NOT NULL DEFAULT 0,
...
DROP TABLE IF EXISTS `group_captain`;
...
DROP TABLE IF EXISTS `keep_knifes`;
...
) ENGINE=InnoDB AUTO_INCREMENT=6775 DEFAULT CHARSET=utf8mb4 COMMENT='每刀資料';
